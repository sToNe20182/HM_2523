...
/*This definition determines whether the demo uses internal PMU AUXADC and ISINK functions. If it is not defined, then the demo uses internal PMU AUXADC and ISINK functions.*/
