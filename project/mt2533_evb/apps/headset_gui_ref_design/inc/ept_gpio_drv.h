...
#define GPIO_PORT0_MODE   MODE_2 // 2:AUXADCIN_0 : Used for AUXADCIN_0
#define GPIO_PORT1_MODE   MODE_1 // 1:EINT1 : Used for EINT1
#define GPIO_PORT2_MODE   MODE_3 // 3:U3RXD : Used for U3RXD
#define GPIO_PORT3_MODE   MODE_0 // 0:GPIO3 : Used for GPIO3
#define GPIO_PORT4_MODE   MODE_2 // 2:MC1_A_CK : Used for MC1_A_CK
#define GPIO_PORT5_MODE   MODE_2 // 2:MC1_A_CM0 : Used for MC1_A_CM0
#define GPIO_PORT6_MODE   MODE_2 // 2:MC1_A_DA0 : Used for MC1_A_DA0
#define GPIO_PORT7_MODE   MODE_2 // 2:MC1_A_DA1 : Used for MC1_A_DA1
#define GPIO_PORT8_MODE   MODE_2 // 2:MC1_A_DA2 : Used for MC1_A_DA2
#define GPIO_PORT9_MODE   MODE_2 // 2:MC1_A_DA3 : Used for MC1_A_DA3
#define GPIO_PORT10_MODE   MODE_9 // 9:BTPRI : Used for BTPRI
#define GPIO_PORT11_MODE   MODE_3 // 3:MA_EDIDO : Used for MA_EDIDO
#define GPIO_PORT12_MODE   MODE_3 // 3:MA_EDIDI : Used for MA_EDIDI
#define GPIO_PORT13_MODE   MODE_3 // 3:MA_EDIWS : Used for MA_EDIWS
#define GPIO_PORT14_MODE   MODE_3 // 3:MA_EDICK : Used for MA_EDICK
#define GPIO_PORT15_MODE   MODE_1 // 1:EINT13 : Used for EINT13
#define GPIO_PORT16_MODE   MODE_1 // 1:U0RXD : Used for U0RXD
#define GPIO_PORT17_MODE   MODE_1 // 1:U0TXD : Used for U0TXD
...
#define GPIO_PORT21_MODE   MODE_1 // 1:KROW2 : Used for KROW2
#define GPIO_PORT22_MODE   MODE_0 // 0:GPIO22 : Used for GPIO22
#define GPIO_PORT23_MODE   MODE_3 // 3:CLKO0 : Used for CLKO0
#define GPIO_PORT24_MODE   MODE_3 // 3:CLKO1 : Used for CLKO1
...
#define GPIO_PORT29_MODE   MODE_5 // 5:EINT10 : Used for EINT10
#define GPIO_PORT30_MODE   MODE_1 // 1:SCL0 : Used for SCL0
#define GPIO_PORT31_MODE   MODE_1 // 1:SDA0 : Used for SDA0
#define GPIO_PORT32_MODE   MODE_9 // 9:MA_SPI3_B_CS : Used for MA_SPI3_B_CS
#define GPIO_PORT33_MODE   MODE_9 // 9:MA_SPI3_B_SCK : Used for MA_SPI3_B_SCK
#define GPIO_PORT34_MODE   MODE_9 // 9:MA_SPI3_B_MOSI : Used for MA_SPI3_B_MOSI
#define GPIO_PORT35_MODE   MODE_9 // 9:MA_SPI3_B_MISO : Used for MA_SPI3_B_MISO
#define GPIO_PORT36_MODE   MODE_2 // 2:SCL1 : Used for SCL1
#define GPIO_PORT37_MODE   MODE_2 // 2:SDA1 : Used for SDA1
#define GPIO_PORT38_MODE   MODE_1 // 1:LSRSTB : Used for LSRSTB
#define GPIO_PORT39_MODE   MODE_1 // 1:LSCE_B0 : Used for LSCE_B0
#define GPIO_PORT40_MODE   MODE_1 // 1:LSCK0 : Used for LSCK0
#define GPIO_PORT41_MODE   MODE_1 // 1:LSDA0 : Used for LSDA0
#define GPIO_PORT42_MODE   MODE_1 // 1:LSA0DA0 : Used for LSA0DA0
#define GPIO_PORT43_MODE   MODE_1 // 1:LPTE : Used for LPTE
