...
//#define GRAPHICLOG printf

typedef enum {    
    TOUCH_EVENT_UP = 0,                         /*release on touch*/
    TOUCH_EVENT_DOWN ,                          /*press on touch*/
    TOUCH_EVENT_MOVE,                           /*move onf touch*/
    TOUCH_EVENT_LONGTAP,                        /*longtap on touch*/
    TOUCH_EVENT_REPEAT,                         /*repeat on touch*/
    TOUCH_EVENT_LONGTAP_HOLD,                   /*longtap hold*/
    TOUCH_EVENT_REPEAT_HOLD,                    /*repeat hold */
    TOUCH_EVENT_ABORT ,
    TOUCH_EVENT_MAX
} touch_event_enum;
