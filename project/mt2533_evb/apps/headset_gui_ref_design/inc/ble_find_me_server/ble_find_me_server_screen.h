 ...
 */
#ifndef __BLE_FIND_ME_SERVER_SCREEN_H__
#define __BLE_FIND_ME_SERVER_SCREEN_H__
...
} ble_fmps_screen_cntx;

typedef enum {
    BLE_FMPS_SHOW_DISABLE_ALERT,
    BLE_FMPS_SHOW_ENABLE_ALERT
} ble_fmps_show_type_t;
