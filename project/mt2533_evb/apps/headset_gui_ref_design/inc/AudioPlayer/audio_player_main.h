...
#define AUDIO_PLAYER_FILE_PATH      _T("0:/music")

#if _USE_LFN
#define AUDIO_PLAYER_PATH_LENGTH    (255)

#define AUDIO_PLAYER_FILE_LENGTH    (127)
#else
...
#define AUIDO_SKIP_ID3_FILE_LENGHT  (2 * 1024)

#define AUDIO_PLAYER_FILE_NUMBER    (300)
