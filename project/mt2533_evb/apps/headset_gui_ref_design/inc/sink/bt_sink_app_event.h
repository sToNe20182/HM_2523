...
#define BT_SINK_EVENT_APP_SYS_LOG_ON          (BT_SINK_SRV_EVENT_USER + 4)
#define BT_SINK_EVENT_APP_SYS_LOG_OFF         (BT_SINK_SRV_EVENT_USER + 5)
#define BT_SINK_EVENT_APP_KEY_INPUT           (BT_SINK_SRV_EVENT_USER + 7)
#define BT_SINK_EVENT_APP_NOTIFICATION        (BT_SINK_SRV_EVENT_USER + 8)
