...
/*Define MSDC0 IO driving capability. 
    ...
    3:MSDC_IO_16MA
*/
#define MSDC_0_CONTROL_LINE_DRIVING_CAPABILITY (2)
#define MSDC_0_DATA_LINE_DRIVING_CAPABILITY    (2)
...
/*Define MSDC1 IO driving capability. 
    ...
    3:MSDC_IO_16MA
*/
#define MSDC_1_CONTROL_LINE_DRIVING_CAPABILITY (2)
#define MSDC_1_DATA_LINE_DRIVING_CAPABILITY    (2)
...
/*Define the MSDC port is used by FS.
    ...
    1: HAL_SD_PORT_1
*/
#define FS_USE_MSDC_PORT_NUMBER (1)
...
/*Define the MSDC port is used by Mass Storage. It is always equal to FS_USE_MSDC_PORT_NUMBER.
    ...
    1: HAL_SD_PORT_1
*/
#define MASS_STORAGE_USE_MSDC_PORT_NUMBER (1)
