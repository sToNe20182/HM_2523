 ...
 * @{
 * @addtogroup mt7682_hdk_hal_examples_i2c_control_EEPROM_with_dma_ex i2c_control_EEPROM_with_dma_ex
 * @{
...
@par Hardware and software environment
  ...
  - Note:
    - The pull-up resistors are needed for the I2C interface to provide the
      ...
      7682 HDK, the two pull-up resistors is not installed for the I2C0 interface. 
...
@par Directory contents
  - Source and header files
    ...
    - \b CC/startup_mt7682.s.           MT7682 startup file for GCC.
...
@par Run the example
  ...
  - Make sure disconnect the jumper for J2013.1 and J2013.2 and connect J2107.1 and J2107.2 with a jumper.
    ...
    J2011.1 and GND of EEPROM with J2111.1 GND on LinkIt 7682 HDK.
