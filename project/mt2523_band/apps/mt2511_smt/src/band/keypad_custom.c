...
bool keypad_custom_normal_init(void)
{
    ...
    keypad_config.debounce              = 16;                                   /*set to 16ms debounce*/
    ...
    keypad_config.repeat_time           = 1000;
    keypad_config.longpress_time        = 2000;
...
bool keypad_custom_powerkey_init(void)
{
    ...
    powerkey_context.repeat_time     = 1000;
    powerkey_context.longpress_time  = 2000;
