...
static char* local_device_name = "watch_demo";
...
#if !defined(__MTK_BLE_ONLY_ENABLE__)
static bt_gap_config_t* bt_app_common_get_local_configuration(void);

static bt_gap_config_t bt_custom_config_default = {
    .inquiry_mode = 2,
    .io_capability = BT_GAP_IO_CAPABILITY_NO_INPUT_NO_OUTPUT,
    .cod = 0x280704,
    .device_name = {"watch_demo"},
};

static bt_gap_config_t* bt_app_common_get_local_configuration(void)
{
    return &bt_custom_config_default;
}
#endif
...
static void bt_app_common_advtising_init(void)
{
    ...
    bt_hci_cmd_le_set_scan_response_data_t scan_data = {
        ...
        .scan_response_data = "DDwatch_demo",
    };
...
#if !defined(__MTK_BLE_ONLY_ENABLE__)
    bt_callback_manager_register_callback(bt_callback_type_gap_get_local_configuration, 0, (void *)bt_app_common_get_local_configuration); 
#endif 
