...
void SwipeContainer::printLog()
{
#ifndef SIMULATOR
    if (numberOfScreens == HomePresenter::MAX_DEMO_ID) {
        switch (currentScreen) {
            case HomePresenter::NOTIFICATION:
                LOG_I(tgfx, "Current UI: Home Notifications\r\n");
                break;
            case HomePresenter::CLOCK_FACE:
                LOG_I(tgfx, "Current UI: Home Clock\r\n");
                break;
            case HomePresenter::PLAYER:
                LOG_I(tgfx, "Current UI: Home MP3\r\n");
                break;
            default:
                break;
        }
    } else if (numberOfScreens == MainMenuPresenter::MAX_DEMO_ID) {
        switch (currentScreen) {
            case MainMenuPresenter::HEART_RATE:
                LOG_I(tgfx, "Current UI: Main Menu HR\r\n");
                break;
            case MainMenuPresenter::BLOOD_PRESURE:
                LOG_I(tgfx, "Current UI: Main Menu Blood Presure\r\n");
                break;
            case MainMenuPresenter::FIND_ME:
                LOG_I(tgfx, "Current UI: Main Menu FMP\r\n");
                break;
            case MainMenuPresenter::GPS:
                LOG_I(tgfx, "Current UI: Main Menu GPS\r\n");
                break;
            case MainMenuPresenter::SPORT:
                LOG_I(tgfx, "Current UI: Main Menu Sports\r\n");
                break;
            case MainMenuPresenter::SETTINGS:
                LOG_I(tgfx, "Current UI: Main Menu Settings\r\n");
                break;
            default:
                break;
        }
