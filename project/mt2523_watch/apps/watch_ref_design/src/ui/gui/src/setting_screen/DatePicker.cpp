    ...
    onSelectedElementChanged(this, &DatePicker::selectedElementChangedHandler)
{
    ...
    days.setXY(CommonUI::DATETIME_DAYS_X, CommonUI::DATETIME_DAYS_Y);
    days.setupDatePickerWheelDay(CommonUI::DATETIME_DAYS_WIDTH, CommonUI::DATETIME_DAYS_HEIGHT, 0, 80, T_DATEPICKER_DAY_28, T_DATEPICKER_DAY_29, T_DATEPICKER_DAY_30, T_DATEPICKER_DAY_31);
    days.setTextColor(normalTextColor, selectedTextColor, selectedBackgroundColor, 80, 40);
    add(days);

    months.setXY(CommonUI::DATETIME_MONTHS_X, CommonUI::DATETIME_MONTHS_Y);
    months.setup(CommonUI::DATETIME_MONTHS_WIDTH, CommonUI::DATETIME_MONTHS_HEIGHT, 0, 80, T_DATEPICKER_MONTHS);
    months.setTextColor(normalTextColor, selectedTextColor, selectedBackgroundColor, 80, 40);
    months.setElementSelectedCallback(onSelectedElementChanged);
    add(months);

    years.setXY(CommonUI::DATETIME_YEARS_X, CommonUI::DATETIME_YEARS_Y);
    years.setup(CommonUI::DATETIME_YEARS_WIDTH, CommonUI::DATETIME_YEARS_HEIGHT, 0, 80, T_DATEPICKER_YEARS);
    years.setTextColor(normalTextColor, selectedTextColor, selectedBackgroundColor, 80, 40);
