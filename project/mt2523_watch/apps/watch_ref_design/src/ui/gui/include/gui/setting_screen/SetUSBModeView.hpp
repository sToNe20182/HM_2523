...
#ifndef SET_USB_MODE_VIEW_HPP
#define SET_USB_MODE_VIEW_HPP
...
class SetUSBModeView : public DemoView<SetUSBModePresenter>
{
public:
    SetUSBModeView();
    virtual ~SetUSBModeView();
...
private:
    static const int numberOfListElements = 2;
    ...
    Callback<SetUSBModeView, MenuListElement &> listElementClickedCallback;
};

#endif // SET_USB_MODE_VIEW_HPP
