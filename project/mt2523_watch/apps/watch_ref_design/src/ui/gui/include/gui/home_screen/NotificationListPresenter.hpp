...
#ifndef  NOTIFICATION_LIST_PRESENTER_HPP
#define  NOTIFICATION_LIST_PRESENTER_HPP
 ...
 *
 */
class NotificationListPresenter : public DemoPresenter
{
public:
    NotificationListPresenter(NotificationListView &v);
    ...
    virtual ~NotificationListPresenter() {};
...
#endif //  NOTIFICATION_LIST_PRESENTER_HPP
