...
public:
    DemoView() :
        onGotoHomeButtonClicked(this, &DemoView::gotoHomeClickedHandler),
        ...
        onGotoBTSettingButtonClicked(this, &DemoView::gotoBTSettingClickedHandler)
    {
        gotoHomeButton.setAction(onGotoHomeButtonClicked);
        gotoMenuButton.setAction(onGotoMenuButtonClicked);
        gotoSettingButton.setAction(onGotoSettingButtonClicked);
        gotoBTSettingButton.setAction(onGotoBTSettingButtonClicked);
    }
...
protected:
    ...
    Button gotoBTSettingButton;

    Callback<DemoView, const AbstractButton &> onGotoHomeButtonClicked;
    ...
    Callback<DemoView, const AbstractButton &> onGotoBTSettingButtonClicked;

    void gotoHomeClickedHandler(const AbstractButton &button)
    {
        View<T>::presenter->backOptionHomeSelected();
    }
    ...
    void gotoBTSettingClickedHandler(const AbstractButton &button)
    {
        View<T>::presenter->backBTConnectionView();
    }
};
