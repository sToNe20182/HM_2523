...
public:
    ...
    */
    ...
    void gotoMassStorageScreen();
    void gotoMainMenuScreen();
    void backMainMenuScreen();
    void gotoSettingScreen();
    void backSettingScreen();
    void gotoSetClockScreen();
    void gotoSetTimeScreen();
    void gotoSetDateScreen();
    void gotoSetBluetoothScreen();
    void gotoSetHeartRateScreen();
    void gotoSetGPSScreen();
    void gotoScreenTimeoutScreen();
    void gotoUSBModeScreen();
    void gotoBTConnectionScreen();
    void backBTConnectionScreen();
    void gotoBTDeviceOpScreen();
    void gotoBTDeviceSearchListScreen();
...
private:
    ...
    void backHomeScreenImpl();
    void gotoNotificationScreenImpl();
    void gotoMassStorageScreenImpl();
    void gotoMainMenuScreenImpl();
    void backMainMenuScreenImpl();
    void gotoSettingScreenImpl();
    void backSettingScreenImpl();
    void gotoSetClockScreenImpl();
    void gotoSetTimeScreenImpl();
    void gotoSetDateScreenImpl();
    void gotoSetBluetoothScreenImpl();
    void gotoSetHeartRateScreenImpl();
    void gotoSetGPSScreenImpl();
    void gotoScreenTimeoutScreenImpl();
    void gotoUSBModeScreenImpl();
    void gotoBTConnectionScreenImpl();
    void backBTConnectionScreenImpl();
    void gotoBTDeviceOpScreenImpl();
    void gotoBTDeviceSearchListScreenImpl();
