...
#ifndef SCREEN_TIMEOUT_VIEW_HPP
#define SCREEN_TIMEOUT_VIEW_HPP
...
class ScreenTimeoutView : public DemoView<ScreenTimeoutPresenter>
{
public:
    ScreenTimeoutView();
    virtual ~ScreenTimeoutView();
...
private:
    ...
    Callback<ScreenTimeoutView, MenuListElement &> listElementClickedCallback;
};

#endif // SCREEN_TIMEOUT_VIEW_HPP
