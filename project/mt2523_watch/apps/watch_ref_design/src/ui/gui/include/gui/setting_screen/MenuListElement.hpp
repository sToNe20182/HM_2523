...
public:
     ...
     */
    void setupListElement(uint8_t index, const Bitmap &bg, const Bitmap &bmp, TypedText t);
    void setupListElement(uint8_t index, const Bitmap &bg, const Bitmap &bmp, TextAreaWithOneWildcard *t);
    void setupListElementEx(uint8_t index, const Bitmap &bg, const Bitmap &bmp, TextAreaWithOneWildcard *t);
    void setupLastElement();

    void removeListElement(uint8_t index, const Bitmap &bmp, TextAreaWithOneWildcard *t);
