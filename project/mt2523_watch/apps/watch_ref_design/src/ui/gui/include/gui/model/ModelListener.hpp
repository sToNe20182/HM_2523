...
public:
    ...
    virtual void heartRateDataUpdated(int heartRateData) {}

    virtual void capacityUpdated(int capacityData) {}

    virtual void gSensorUpdated(int stepData) {}

    virtual bool bloodPresureTipsStartCheck()
    {
        return false;
    }

    virtual void bloodPresureTipsUpdated(int count) {}

    virtual void bloodPresureCaculating() {}

    virtual void bloodPresureShowResult(int hbpData, int lbpData) {}
