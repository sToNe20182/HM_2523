 ...
 * @{
 * @addtogroup linkit7697_hdk_hal_examples_i2c_control_EEPROM_with_dma i2c_control_EEPROM_with_dma
 * @{
...
@par Run the example
  ...
  - Connect J2.4(P8) and J2.5(P9) to the SCL (clock) and SDA (data) pins of the
    M24C01 EEPROM device, respectively. Connect VCC of EEPROM to J2.1(3V3) and
    GND of EEPROM to J2.14(GND) on LinkIt 7687 HDK.
