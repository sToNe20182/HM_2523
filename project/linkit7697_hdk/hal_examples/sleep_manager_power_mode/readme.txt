 ...
 * @{
 * @addtogroup linkit7697_hdk_hal_examples_sleep_manager_power_mode sleep_manager_power_mode
 * @{
...
@par Hardware and software environment
  ...
  - Note:
    - Please refer to LinkIt 7697 HDK Power Consumption Measurement Guide
      about how to connect power monitor with 7697 HDK board.
  ...
  - Customization Option
    - \b MTK_WIFI_REPEATER_ENABLE:
      ...
      address when local STA communcation with 7697 in repeater mode. This is
...
@par Run the example
  - Build the example project with the command "./build.sh linkit7697_hdk
  ...
  - Connect the power monitor to the LinkIt 7697 HDK (optional).
