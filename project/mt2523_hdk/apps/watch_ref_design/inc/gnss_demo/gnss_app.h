...
//#define GNSS_SUPPORT_AT_COMMAND
...
typedef struct gnss_location_disp_struct {
    int8_t lat_h;
    int8_t lat_m;
    int8_t lat_s;
    int8_t long_h;
...
typedef void (*gnss_location_callback_f) (gnss_location_disp_struct_t* position);
...
extern void gnss_register_callback(gnss_location_callback_f call_back);
