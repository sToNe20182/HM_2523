 ...
 */
log_create_module(mp3_demo, PRINT_LEVEL_INFO);
...
int main(void)
{
    ...
    //create mp3 codec unit test
        LOG_I(mp3_demo,"mp3 play test main!!\n\r");
    xTaskCreate(mp3_codec_ut, MP3_PLAY_EXAMPLE_TASK_NAME, MP3_PLAY_EXAMPLE_TASK_STACKSIZE/sizeof(StackType_t), NULL, MP3_PLAY_EXAMPLE_TASK_PRIO, NULL);
#endif
