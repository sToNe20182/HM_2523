...
#define BT_A2DP_SINK_CODEC_NUM (2)                          /**< Sink Codec num: AAC, SBC.*/
#define BT_A2DP_SEP_TOTAL_NUM (2 * BT_A2DP_SINK_CODEC_NUM)  /**< A2DP total SEP num: link numer (2) * sink codec num. */
