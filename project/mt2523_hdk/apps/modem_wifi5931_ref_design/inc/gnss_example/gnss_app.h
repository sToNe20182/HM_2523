...
typedef enum {
    GNSS_EPO_AIDING_FLAG = 0x1,
    GNSS_TIME_AIDING_FLAG = 0x2,
    GNSS_LOC_AIDING_FLAG = 0x4
} gnss_aiding_flag_enum;
...
extern void gnss_send_msg(gnss_message_id_enum message_id, int32_t param1, void* param2);

extern void gnss_set_aiding_flag(gnss_aiding_flag_enum flag, int32_t is_on);

extern int32_t gnss_get_aiding_flag(gnss_aiding_flag_enum flag);

extern void gnss_demo_app_restart(void);
