...
#ifdef MTK_WIFI_STUB_CONF_ENABLE
    uint16_t evt = WFC_EVT_WIFI_CONNECTED;
#endif
...
#ifdef MTK_WIFI_STUB_CONF_ENABLE
    wfc_send_to_host((uint8_t *)&evt, sizeof(evt), 1);
#endif
...
#ifdef MTK_WIFI_STUB_CONF_ENABLE
    uint16_t evt = WFC_EVT_WIFI_DISCONNECT;
#endif
...
static int8_t _ip_show(char *ifname)
{
