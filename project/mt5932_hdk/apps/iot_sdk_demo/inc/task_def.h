...
// increased from 4 to 6 due to pbuf_free issue because of low priority
#define IPERF_TASK_PRIO                6 //TASK_PRIORITY_NORMAL
...
/* for wifi main demo task definition */
#define WIFI_MAIN_DEMO_TASK_NAME       "wifi_main_task"
#define WIFI_MAIN_DEMO_TASK_STACKSIZE  (1024*4) /*unit byte!*/
#define WIFI_MAIN_DEMO_TASK_PRIO       TASK_PRIORITY_NORMAL


#if MTK_WIFI_STUB_CONF_ENABLE
/* for wifi wfc task definition */
#define WFC_QUEUE_TASK_NAME            "wfq"
#define WFC_QUEUE_TASK_STACK_SIZE      1024
#define WFC_QUEUE_TASK_PRIORITY        TASK_PRIORITY_HIGH
#define WFC_QUEUE_SIZE                 10

#define WFC_MQ_TASK_NAME               "wfmq"
#define WFC_MQ_TASK_STACK_SIZE         1024
#define WFC_MQ_TASK_PRIORITY           TASK_PRIORITY_HIGH
#define WFC_MQ_SIZE                    10
#endif
