 ...
 * @{
 * @addtogroup mt5932_hdk_templates templates
 * @{
 * @addtogroup mt5932_hdk_templates_no_rtos_initialize_system no_rtos_initialize_system
 * @{
...
@par Directory contents
  - Source and header files
    ...
    - \b src/system_mt5932.c:   mt5932x clock configuration file.
    - \b inc/hal_feature_config.h:
                                mt5932x feature configuration file.
    - \b inc/memory_map.h:      mt5932x memory layout symbol file.
    - \b GCC/startup_mt5932.s:  mt5932x start up file for GCC.
    - \b GCC/syscalls.c:        mt5932x syscalls for GCC.
    - \b MDK-ARM/startup_mt5932.s:
                                mt5932x start up file for Keil IDE.
...
@par Run the example
  - Build the project with a command "./build.sh mt5932_hdk
