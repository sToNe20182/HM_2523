 ...
 * @{
 * @addtogroup mt5932_hdk_templates_freertos_create_thread freertos_create_thread
 * @{
...
@par Hardware and software environment
  ...
  - Environment configuration
    ...
    - Install the mbed serial driver according to the instructions at
      ...
      more information, please refer to section "Installing the LinkIt 5932
      HDK drivers on Microsoft Windows" on the "LinkIt 5932 HDK User Guide"
      in [sdk_root]/doc folder.
    - Use a type-A to micro-B USB cable to connect type-A USB of the PC and
      MK20 micro-B USB connector on the LinkIt 5932 HDK. For more information
...
@par Directory contents
  - Source and header files
    ...
    - \b src/system_mt5932.c:   The configuration file of the Cortex-M4 with
    ...
    - \b GCC/startup_mt5932.s:  MT7682x startup file for GCC.
  ...
  - Project configuration files using GCC
    ...
    - \b GCC/mt5932_flash.ld:   Linker script.
...
@par Run the demo
  - Build the example project with a command "./build.sh mt5932_hdk
    freertos_create_thread" from the SDK root folder and download the binary
    file to LinkIt 5932 HDK.
