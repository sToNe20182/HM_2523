...
#ifndef MODEM_ON_HDK_ENABLE    // F300
#define SKIP_PINMUX
#define MODEM_GPIO_NAME_BY_DWS
#endif

#ifndef MODEM_GPIO_NAME_BY_DWS 
#define MODEM_WAKEUP_EINT                   HAL_EINT_NUMBER_1
#define MODEM_EXCEPTION_EINT                HAL_EINT_NUMBER_11

#define TRIGGER_MODEM_RESET_PIN             HAL_GPIO_14
#define UPDATE_HOST_STATUS_PIN              HAL_GPIO_11
#define QUERY_MODEM_STATUS_PIN              HAL_GPIO_12
#define TRIGGER_MODEM_WAKEUP_PIN            HAL_GPIO_0
#else
...
extern msm_ret_t msm_gpio_clear_wakeup_to_modem();
